#include "InstanceAmbientShader.h"


InstanceAmbientShader::InstanceAmbientShader()
{
	// load the shaders
...
GLuint InstanceAmbientShader::getModelMatrixID()
{
	return modelMatrixID;
}

void InstanceAmbientShader::setAmbientColor(glm::vec3 color)
{
